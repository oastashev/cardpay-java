...
/**
 * For BITCOIN payment method only
 */
@ApiModel(description = "For BITCOIN payment method only")

public class PayoutCryptocurrencyAccount {
  ...
  public PayoutCryptocurrencyAccount cryptoAddress(String cryptoAddress) {
    this.cryptoAddress = cryptoAddress;
    return this;
  }

   /**
   * Customer&#39;s bitcoin address can be used for payout *(for BITCOIN payment method only)*
   * @return cryptoAddress
  **/
  @ApiModelProperty(example = "1KKQopKKDYMtp7kavZH1YF882uMpoaxSLq", value = "Customer's bitcoin address can be used for payout *(for BITCOIN payment method only)*")
  ...
  public PayoutCryptocurrencyAccount cryptoTransactionId(String cryptoTransactionId) {
  ...
  **/
  ...
  public PayoutCryptocurrencyAccount prcAmount(BigDecimal prcAmount) {
   ...
   * @return prcAmount
  **/
  @ApiModelProperty(example = "0.00423", value = "Transaction amount")
  ...
  public PayoutCryptocurrencyAccount prcCurrency(String prcCurrency) {
   ...
   * @return prcCurrency
  **/
  @ApiModelProperty(value = "Currency of transaction")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PayoutCryptocurrencyAccount payoutCryptocurrencyAccount = (PayoutCryptocurrencyAccount) o;
    return Objects.equals(this.cryptoAddress, payoutCryptocurrencyAccount.cryptoAddress) &&
        Objects.equals(this.cryptoTransactionId, payoutCryptocurrencyAccount.cryptoTransactionId) &&
        Objects.equals(this.prcAmount, payoutCryptocurrencyAccount.prcAmount) &&
        Objects.equals(this.prcCurrency, payoutCryptocurrencyAccount.prcCurrency);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayoutCryptocurrencyAccount {\n");
