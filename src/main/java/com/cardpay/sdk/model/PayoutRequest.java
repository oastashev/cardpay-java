...
import com.cardpay.sdk.model.PayoutMerchantOrder;
...
public class PayoutRequest {
  ...
  private PayoutMerchantOrder merchantOrder = null;
  ...
  **/
  ...
  public PayoutRequest cardAccount(PayoutCardAccount cardAccount) {
    this.cardAccount = cardAccount;
    return this;
  }

   /**
   * Bank card account data *(for BANKCARD payment method only)*
   * @return cardAccount
  **/
  @ApiModelProperty(value = "Bank card account data *(for BANKCARD payment method only)*")
  ...
  public PayoutRequest cryptocurrencyAccount(PayoutCryptocurrencyAccount cryptocurrencyAccount) {
  ...
  **/
  ...
  public PayoutRequest customer(PayoutCustomer customer) {
  ...
  **/
  ...
  public PayoutRequest ewalletAccount(PayoutEWalletAccount ewalletAccount) {
  ...
  **/
  @ApiModelProperty(required = true, value = "eWallet account data *(for NETELLER, WEBMONEY and QIWI payment methods only)*")
  ...
  public PayoutRequest merchantOrder(PayoutMerchantOrder merchantOrder) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Merchant order")
  public PayoutMerchantOrder getMerchantOrder() {
    return merchantOrder;
  }

  public void setMerchantOrder(PayoutMerchantOrder merchantOrder) {
    this.merchantOrder = merchantOrder;
  }
  ...
  **/
  ...
  public PayoutRequest payoutData(PayoutData payoutData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.request, payoutRequest.request) &&
        Objects.equals(this.cardAccount, payoutRequest.cardAccount) &&
        Objects.equals(this.cryptocurrencyAccount, payoutRequest.cryptocurrencyAccount) &&
        Objects.equals(this.customer, payoutRequest.customer) &&
        Objects.equals(this.ewalletAccount, payoutRequest.ewalletAccount) &&
        Objects.equals(this.merchantOrder, payoutRequest.merchantOrder) &&
        Objects.equals(this.paymentData, payoutRequest.paymentData) &&
        Objects.equals(this.paymentMethod, payoutRequest.paymentMethod) &&
        Objects.equals(this.payoutData, payoutRequest.payoutData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(request, cardAccount, cryptocurrencyAccount, customer, ewalletAccount, merchantOrder, paymentData, paymentMethod, payoutData);
  }
